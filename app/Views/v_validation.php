...
<div class="container">
    ...
    <?php endif ?>
    <?= form_open('validation/submit') ?>
        <label for="nip">NIP:</label><br>
        <input type="text" id="nip" name="nip" value="<?= old('nip') ?>"><br>

        <label for="nama">Nama:</label><br>
        <input type="text" id="nama" name="nama" value="<?= old('nama') ?>"><br>

        <label for="tgl_lahir">Tanggal Lahir:</label><br>
        <input type="date" id="tgl_lahir" name="tgl_lahir" value="<?= old('tgl_lahir') ?>"><br>
        ...
        <select id="pendidikan" name="pendidikan">
            ...
            <option value="dst" <?= old('pendidikan') === 'dst' ? 'selected' : '' ?>>DST</option>
        </select><br>
